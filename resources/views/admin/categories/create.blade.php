    ...
    <div class="bg-gray-100 px-10 py-6 mx-10 rounded-md shadow-md">
        <div class="flex items-center gap-4 md:flex-row md:justify-between">
            ...
            <nav aria-label="Breadcrumb">
                <ol class="flex items-center justify-end gap-1 text-sm text-gray-700">
                    ...
                    <li>
                        <a class="block transition-colors hover:text-gray-900"> Creer une catégorie </a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <form name="categoryForm" id="categoryForm">
            ...
            <div class="grid grid-cols-3 gap-4">
                    ...
                    <input type="text" class="mt-0.5 w-50 rounded border-gray-300 shadow-sm sm:text-sm" id="name_fr" name="name_fr" placeholder="Nom de la catégorie (en français)">
                    <p></p>
                </div>
                <div class="py-2 flex flex-col">
                    <label for="name_en" class="text-sm font-medium text-gray-700">Catégorie (en)</label>
                    <input type="text" class="mt-0.5  rounded border-gray-300 shadow-sm sm:text-sm" id="name_en" name="name_en" placeholder="Nom de la catégorie (en anglais)">
                    <p></p>
                </div>
                <div class="py-2 flex flex-col">
                    <label for="slug" class="text-sm font-medium text-gray-700">Slug</label>
                    <input type="text" class="mt-0.5  rounded border-gray-300 shadow-sm sm:text-sm" id="slug" name="slug" placeholder="Lien de la catégorie">
                    <p></p>
                </div>
            </div>
            ...
            <div class="py-2">
                ...
                <input type="text" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="icon" name="icon" placeholder="Nom du fichier icône">
                <p></p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="py-2">
                    ...
                    <textarea class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="description_fr" name="description_fr" rows="4" placeholder="Description de la catégorie (en français)"></textarea>
                    <p></p>
                </div>

                <div class="py-2">
                    <label for="description_en" class="text-sm font-medium text-gray-700">Description (en)</label>
                    <textarea class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="description_en" name="description_en" rows="4" placeholder="Description de la catégorie (en anglais)"></textarea>
                    <p></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="py-2">
                    ...
                    <input type="text" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="meta_title_fr" name="meta_title_fr" placeholder="Titre SEO de la catégorie (en français)">
                    <p></p>
                </div>

                <div class="py-2">
                    <label for="meta_title_en" class="text-sm font-medium text-gray-700">Titre SEO (en)</label>
                    <input type="text" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="meta_title_en" name="meta_title_en" placeholder="Titre SEO de la catégorie (en anglais)">
                    <p></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="py-2">
                    ...
                    <input type="text" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="meta_keywords_fr" name="meta_keywords_fr" placeholder="Mots-clés SEO de la catégorie (en français)">
                    <p></p>
                </div>

                <div class="py-2">
                    <label for="meta_keywords_en" class="text-sm font-medium text-gray-700">Mots-clés SEO (en)</label>
                    <input type="text" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="meta_keywords_en" name="meta_keywords_en" placeholder="Mots-clés SEO de la catégorie (en anglais)">
                    <p></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="py-2">
                    ...
                    <textarea class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="meta_description_fr" name="meta_description_fr" rows="3" placeholder="Description SEO de la catégorie (en français)"></textarea>
                    <p></p>
                </div>

                <div class="py-2">
                    <label for="meta_description_en" class="text-sm font-medium text-gray-700">Description SEO</label>
                    <textarea class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" id="meta_description_en" name="meta_description_en" rows="3" placeholder="Description SEO de la catégorie (en anglais)"></textarea>
                    <p></p>
                </div>
            </div>
