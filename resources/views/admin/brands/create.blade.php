    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        ...
        <div class="text-end">
            <ol class="py-0 m-0 breadcrumb">
                ...
                <li class="breadcrumb-item active">Création de la marque</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form name="brandForm" id="brandForm" class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="Lien de la marque">
                            <p></p>
                        </div>
                        <div class="col-md-12">
                                <div class="mb-3">
