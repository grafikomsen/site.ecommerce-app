...
@section('content')
    ...
    <div class="bg-gray-100 p-4 m-4 rounded-md shadow-md">
        ...
        <form name="editProdForm" id="editProdForm">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 bg-gray-100">
                <div class="p-4 rounded lg:col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_fr" name="title_fr" value="{{ $product->title_fr }}" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" placeholder="Titre du produit (en français)">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_en" name="title_en" value="{{ $product->title_en }}" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" placeholder="Titre du produit (en anglais)">
                                <p></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="slug" name="slug"  value="{{ $product->slug }}" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" placeholder="Slug du product">
                            <p></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-3">
                            ...
                            <textarea type="text" id="description_fr" name="description_fr" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="4" rows="5" placeholder="Description du product">{{ $product->description_fr }}</textarea>
                            <p></p>
                        </div>

                        <div class="mb-3">
                            <label for="description_en" class="form-label">Description  <span class=" text-sm">(en anglais)</span></label>
                            <textarea type="text" id="description_en" name="description_en" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="4" rows="5" placeholder="Description du product">{{ $product->description_en }}</textarea>
                            <p></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-3">
                            ...
                            <textarea type="text" id="short_description_fr" name="short_description_fr" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="4" rows="5" placeholder="Description du product">{{ $product->short_description_fr }}</textarea>
                            <p></p>
                        </div>

                        <div class="mb-3">
                            <label for="short_description_en" class="form-label">Description courte <span class=" text-sm">(en anglais)</span></label>
                            <textarea type="text" id="short_description_en" name="short_description_en" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="4" rows="5" placeholder="Description du product">{{ $product->short_description_en }}</textarea>
                            <p></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-3">
                            ...
                            <textarea type="text" id="shipping_returns_fr" name="shipping_returns_fr" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="4" rows="5" placeholder="Description du product">{{ $product->shipping_returns_fr }}</textarea>
                            <p></p>
                        </div>

                        <div class="mb-3">
                            <label for="shipping_returns_en" class="form-label">Retours expédition <span class=" text-sm">(en anglais)</span></label>
                            <textarea type="text" id="shipping_returns_en" name="shipping_returns_en" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="4" rows="5" placeholder="Description du product">{{ $product->shipping_returns_en }}</textarea>
                            <p></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-3">
                            ...
                            <textarea id="meta_description_fr" name="meta_description_fr" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="3" placeholder="Description SEO du produit">{{ $product->meta_description_fr }}</textarea>
                            <p></p>
                        </div>

                        <div class="mb-3">
                            <label for="meta_description_en" class="form-label">Description SEO  <span class=" text-sm">(en anglais)</span></label>
                            <textarea id="meta_description_en" name="meta_description_en" class="w-full resize-none border-none focus:ring-0 sm:text-sm" rows="3" placeholder="Description SEO du produit">{{ $product->meta_description_en }}</textarea>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="p-4 rounded">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="meta_title_fr" name="meta_title_fr" value="{{ $product->meta_title_fr }}" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" placeholder="Titre SEO du produit (en français)">
                        <p></p>
                    </div>

                    <div class="mb-3">
                        <label for="meta_title_en" class="form-label">Titre SEO (en)</label>
                        <input type="text" id="meta_title_en" name="meta_title_en" value="{{ $product->meta_title_en }}" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" placeholder="Titre SEO du produit (en anglais)">
                        <p></p>
                    </div>

                    <div class="mb-3">
                        <label for="meta_keywords_fr" class="form-label">Mots-clés SEO (fr)</label>
                        <input type="text" id="meta_keywords_fr" name="meta_keywords_fr" value="{{ $product->meta_keywords_fr }}" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" placeholder="Mots-clés SEO du produit (en français)">
                        <p></p>
                    </div>

                    <div class="mb-3">
                        <label for="meta_keywords_en" class="form-label">Mots-clés SEO (en)</label>
                        <input type="text" id="meta_keywords_en" name="meta_keywords_en" value="{{ $product->meta_keywords_en }}" class="mt-0.5 w-full rounded border-gray-300 shadow-sm sm:text-sm" placeholder="Mots-clés SEO du produit (en anglais)">
                        <p></p>
                    </div>
